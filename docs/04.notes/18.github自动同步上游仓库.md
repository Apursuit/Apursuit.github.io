...
![3](https://the0n3.top/medias/gayfork/3.png)

### 主动同步：github action定时任务

第一次接触Github fork同步功能，迫不及待的跟issue区的其他佬友分享(x)

![4](https://the0n3.top/medias/gayfork/4.png)
...
![5](https://the0n3.top/medias/gayfork/5.png)

找到左侧上游同步，找到`enable workflow`，启用

![6](https://the0n3.top/medias/gayfork/6.png)

手动运行一次workflow，看看是否成功

![7](https://the0n3.top/medias/gayfork/7.png)

![8](https://the0n3.top/medias/gayfork/8.png)

查看运行细节，成功同步。因为我已经网页手动同步了，这里就没有新的更新需要同步了，所以没有更新。

![9](https://the0n3.top/medias/gayfork/9.png)
