...
![](/medias/ctfshow-web安全防护/1.png)

![](/medias/ctfshow-web安全防护/2.png)
...
![3](/medias/ctfshow-web安全防护/3.png)



![](/medias/ctfshow-web安全防护/4.png")
...
![](/medias/ctfshow-web安全防护/6.png")

导入密钥后可以看到http明文流量了

![](/medias/ctfshow-web安全防护/7.png")



![](/medias/ctfshow-web安全防护/8.png")
...
![9](/medias/ctfshow-web安全防护/9.png)
...
![14](/medias/ctfshow-web安全防护/14.png)
...
![](/medias/ctfshow-web安全防护/11.png")

![](/medias/ctfshow-web安全防护/12.png")
...
![13](/medias/ctfshow-web安全防护/13.png)
...
![](/medias/ctfshow-web安全防护/15.png")

### 无字母数字代码执行

随便输入点什么，后端报错，使用的`eval`来执行字符

![16](/medias/ctfshow-web安全防护/16.png)
...
![18](/medias/ctfshow-web安全防护/18.png)
...
![](/medias/ctfshow-web安全防护/19.png")

base64解码，发现可疑文件`db.php`，再用伪协议读取`db.php`

![20](/medias/ctfshow-web安全防护/20.png)

base64解码`db.php`内容，拿到flag

![21](/medias/ctfshow-web安全防护/21.png)
...
![22](/medias/ctfshow-web安全防护/22.png)

![](/medias/ctfshow-web安全防护/23.png")
...
![24](/medias/ctfshow-web安全防护/24.png)
...
![34](/medias/ctfshow-web安全防护/34.png)
...
![25](/medias/ctfshow-web安全防护/25.png)
...
![27](/medias/ctfshow-web安全防护/27.png)

`flask`工作目录比较常见的是`/app/app.py`，尝试读取源码

![28](/medias/ctfshow-web安全防护/28.png)
...
![31](/medias/ctfshow-web安全防护/31.png)

![32](/medias/ctfshow-web安全防护/32.png)
...
![](/medias/ctfshow-web安全防护/35.png")

### 布尔盲注爆破

username,password都存在sql注入

![](/medias/ctfshow-web安全防护/36.png")

尝试联合查询写入webshell

![](/medias/ctfshow-web安全防护/37.png")

虽然页面报错了，但是成功写入到文件里了

![](/medias/ctfshow-web安全防护/38.png")
...
![39](/medias/ctfshow-web安全防护/39.png)

蚁剑连接数据库，查看flag

![40](/medias/ctfshow-web安全防护/40.png)
