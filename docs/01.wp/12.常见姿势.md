...
![12](https://the0n3.top/medias/show800/12.png)
...
![13](https://the0n3.top/medias/show800/13.png)
...
详细原理：[PHP-FPM 远程命令执行漏洞](https://github.com/JnuSimba/MiscSecNotes/blob/master/漏洞科普/PHP-FPM 远程命令执行漏洞.md)
...
![14](https://the0n3.top/medias/show800/14.png)
...
![15](https://the0n3.top/medias/show800/15.png)

尝试使用这些文件进行包含，发现`**cmd.php`文件不能直接用来包含，需要更改配置文件，`System.php`、`PEAR.php`可以

![16](https://the0n3.top/medias/show800/16.png)

![17](https://the0n3.top/medias/show800/17.png)
