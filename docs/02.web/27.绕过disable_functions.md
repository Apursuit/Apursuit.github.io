...
![00](https://the0n3.top/medias/disable_func/00.png)
...
![1](https://the0n3.top/medias/disable_func/1.png)

burp

![2](https://the0n3.top/medias/disable_func/2.png)


抓包

![3](https://the0n3.top/medias/disable_func/3.png)
...
![4](https://the0n3.top/medias/disable_func/4.png)
...
![5](https://the0n3.top/medias/disable_func/5.png)

在webshell管理界面，加载插件

![6](https://the0n3.top/medias/disable_func/6.png)

在插件界面，可以看到，插件有多种方式绕过disable_functions

![7](https://the0n3.top/medias/disable_func/7.png)
...
![0](https://the0n3.top/medias/disable_func/0.png)
...
![8](https://the0n3.top/medias/disable_func/8.png)

已经上传了代理php文件，通过这个`.antproxy.php`文件创建新进程和php-fpm进程通信，不受php.ini限制

创建webshell副本，通过这个`antproxy.php`文件连接，密码同连接时的密码

![9](https://the0n3.top/medias/disable_func/9.png)

![10](https://the0n3.top/medias/disable_func/10.png)

连接后，终端里可以执行命令了，不过没有权限查看flag


![11](https://the0n3.top/medias/disable_func/11.png)
...
![12](https://the0n3.top/medias/disable_func/12.png)
...
![13](https://the0n3.top/medias/disable_func/13.png)
...
![15](https://the0n3.top/medias/disable_func/15.png)
...
![14](https://the0n3.top/medias/disable_func/14.png)
...
![16](https://the0n3.top/medias/disable_func/16.png)

使用蚁剑disable_functions插件，选择`Apache Mod CGI`模式

可以看到，利用插件前，左侧参数都处于`NO`状态

![17](https://the0n3.top/medias/disable_func/17.png)

使用后，左侧参数都处于`YES`状态，并且可以执行命令了

![18](https://the0n3.top/medias/disable_func/18.png)
...
![19](https://the0n3.top/medias/disable_func/19.png)
...
![20](https://the0n3.top/medias/disable_func/20.png)
...
![25](https://the0n3.top/medias/disable_func/25.png)

开日

![26](https://the0n3.top/medias/disable_func/26.png)

![27](https://the0n3.top/medias/disable_func/27.png)
...
![21](https://the0n3.top/medias/disable_func/21.png)
...
![22](https://the0n3.top/medias/disable_func/22.png)

![23](https://the0n3.top/medias/disable_func/23.png)
...
![24](https://the0n3.top/medias/disable_func/24.png)
...
![28](https://the0n3.top/medias/disable_func/28.png)
...
![29](https://the0n3.top/medias/disable_func/29.png)
...
![30](https://the0n3.top/medias/disable_func/30.png)

蚁剑插件直接开日

使用前，蚁剑为什么没有检测到ffi开启呢？

![31](https://the0n3.top/medias/disable_func/31.png)
...
![32](https://the0n3.top/medias/disable_func/32.png)
...
![33](https://the0n3.top/medias/disable_func/33.png)

![34](https://the0n3.top/medias/disable_func/34.png)

使用插件后，进行的文件操作：创建了`/tmp/gconv_modules`文件夹，上传了`/tmp/恶意.so`文件，以及蚁剑代理流量到指定端口的php文件

![35](https://the0n3.top/medias/disable_func/35.png)

进程里，`/bin/sh`使用php命令开启了一个web服务器，使用`-n`参数，忽略`php.ini`的配置文件影响，从而实现了绕过`disable_functions`的限制

![36](https://the0n3.top/medias/disable_func/36.png)
